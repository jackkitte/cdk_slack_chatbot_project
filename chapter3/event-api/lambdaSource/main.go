...
func eventApiHandler(ctx context.Context, request events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
	...
	case EVENT_CALLBACK_EVENT:
		...
		if len(messages) == 0 || (messages[0] != "down" && messages[0] != "up") {
